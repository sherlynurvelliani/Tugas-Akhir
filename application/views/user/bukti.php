							...
							<div class="card">
								<div class="card-body ">
									...
									<table class="container text-right">
										<tr>
											<td class="text-right">Jumlah Pengunjung</td>
											<td class="container text-right">:</td>
											<td class="text-right"><?= $isi->jumlah_pengunjung;?> Orang</td>
										</tr>
										<tr>
									...
									<div class="text-right">
										<a href="<?=base_url('user/Pengunjung_user/print_bukti/')?><?= $isi->id_booking;?>" class="btn btn-info btn-sm text-center">Download</a>
									</div>
								</div>
							</div>
						</div>
