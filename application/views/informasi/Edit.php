			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						...
						echo form_open(base_url('admin/informasi/edit/'.$informasi->id_informasi));
						?>
						<!-- id informasi -->
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" name="ket" class="form-control" placeholder="keterangan" value="<?php  echo $informasi->ket ?>" required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="date" name="tanggal" class="form-control" placeholder="tanggal" value="<?php echo $informasi->tanggal?>" required>
							</div>
						</div>
