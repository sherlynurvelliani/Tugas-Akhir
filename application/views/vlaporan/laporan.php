        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <h4 class="small font-weight-bold">Cetak Berdasarkan Tanggal</h4>
                    <form action="<?= base_url('Claporan/filter') ?>" method="POST" target="_blank">
...
<div class="col-lg-6">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <h4 class="small font-weight-bold">Cetak Berdasarkan Tanggal</h4>
                <form action="<?= base_url('Claporan/filter2') ?>" method="POST" target="_blank">
                    <input type="hidden" name="nilaifilterk" value="1">
                    <div class="row form-group">
                        <label class="col-lg-3 text-lg-right" for="tanggal">Tanggal Awal</label>
                        <div class="col-lg-5">
                            <div class="input-group">
                                <input type="date" class="form-control" name="tanggalawalk">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="fa fa-fw fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <input type="date" class="form-control" name="tanggalakhirk">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="fa fa-fw fa-calendar"></i></span>
                                </div>
                            </div>
            ...
            <h4 class="small font-weight-bold">Cetak Berdasarkan Bulan</h4>
                <form action="<?= base_url('Claporan/filter2') ?>" method="POST" target="_blank">
                    <input type="hidden" name="nilaifilterk" value="2">
                    <div class="row form-group">
                        <label class="col-lg-3 text-lg-right" for="tanggal">Tahun</label>
                        <div class="col-lg-5">
                            <div class="input-group">
                                <select class="form-control" name="tahun1k" required="">
                                    <?php foreach ($tahun as $row): ?>
                                        <option value="<?php echo $row->tahun ?>"><?php echo $row->tahun ?></option>
                                    <?php endforeach ?>
                                </select><br>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <select class="form-control" name="bulanawalk" required="">
                                    <option value="1">Januari</option>
                                    <option value="2">Februari</option>
                                    <option value="3">Maret</option>
                                    <option value="4">April</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <select class="form-control" name="bulanakhirk" required="">
                                    <option value="1">Januari</option>
                                    <option value="2">Februari</option>
                                    <option value="3">Maret</option>
                                    <option value="4">April</option>
            ...
            <h4 class="small font-weight-bold">Cetak Berdasarkan Tahun</h4>
                <form action="<?= base_url('Claporan/filter2') ?>" method="POST" target="_blank">
                    <input type="hidden" name="nilaifilterk" value="3">
                    <div class="row form-group">
                        <label class="col-lg-3 text-lg-right" for="tanggal">Tahun</label>
                        <div class="col-lg-5">
                            <div class="input-group">
                                <select class="form-control" name="tahun2k" required="">
                                    <?php foreach ($tahun as $row): ?>
                                        <option value="<?php echo $row->tahun ?>"><?php echo $row->tahun ?></option>
                                    <?php endforeach ?>
                                </select><br>
