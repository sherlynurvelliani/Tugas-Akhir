    ...
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2">Wisata Taman Narmada</h2>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker"></span><span class="text text-white">203 Fake St. Mountain View, San Francisco, California, USA</span></li>
