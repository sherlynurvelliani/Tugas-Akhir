					...
					<div class="card-body">
						...
						<!-- nama pengunjung -->
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
										<input type="number" id="jml_anak" min="0" name="jml_anak" class="form-control" value="<?php echo $pengunjung->jml_anak; ?>">
									</div>
									<div class="col-md-2">
										<input readonly type="number" id="jml_harga_anak" name="jml_harga_anak" class="form-control">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
										<input type="number" id="jml_wna" min="0" name="jml_wna" class="form-control" value="<?php echo $pengunjung->jml_wna; ?>">
									</div>
									<div class="col-md-2">
								...
								<div class="form-group row">
									...
									<div class="col-md-2 left">
										<input class="form-check-input" type="radio" name="status_bayar" id="exampleRadios1" value="sudah"<?php echo ($pengunjung->status_bayar == 'sudah' ? 'checked' : ''); ?>/>								
										<label class="form-check-label" for="exampleRadios1">Sudah Bayar</label>
									</div>
									<div class="col-md-2">
										<input class="form-check-input" type="radio" name="status_bayar" id="exampleRadios3"  value="belum"<?php echo ($pengunjung->status_bayar == 'belum' ? 'checked' : ''); ?>/>
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<textarea name="catatan" class="form-control" id="catatan" rows="3"><?= $pengunjung->catatan?></textarea>
									</div>
								</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		data_url = $('#jml_dewasa').val();
		alert(data_url);
		// $("input#jml_dewasa").load(function () {
		// 	var jml = $(this).val();
		// 	var tipe = 'Dewasa';
		// 	$.ajax({
